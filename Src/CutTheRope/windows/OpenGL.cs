...
namespace GameManager.windows
{
    internal class OpenGL
    {
        ...
        private static global::GameManager.iframework.visual.Texture2D s_Texture;

        private static global::GameManager.iframework.visual.Texture2D s_Texture_OptimizeLastUsed;
        ...
        public static void glBindTexture(global::GameManager.iframework.visual.Texture2D t)
        {
            s_Texture = t;
        }
